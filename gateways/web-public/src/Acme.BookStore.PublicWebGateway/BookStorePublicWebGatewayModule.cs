...
using Acme.BookStore.Shared.Hosting.Gateways;
using Ocelot.Middleware;
using Volo.Abp;
using Volo.Abp.Modularity;

namespace Acme.BookStore.PublicWebGateway;

[DependsOn(
    typeof(BookStoreSharedHostingGatewaysModule)
)]
public class BookStorePublicWebGatewayModule : AbpModule
{
