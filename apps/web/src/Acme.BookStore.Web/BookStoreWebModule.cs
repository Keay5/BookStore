...
using Acme.BookStore.AdministrationService.Web;
using Acme.BookStore.IdentityService;
using Acme.BookStore.IdentityService.Web;
using Acme.BookStore.Localization;
using Acme.BookStore.ProductService;
using Acme.BookStore.ProductService.Web;
using Acme.BookStore.SaasService;
using Acme.BookStore.SaasService.Web;
using Acme.BookStore.Shared.Hosting.AspNetCore;
using Acme.BookStore.Web.Navigation;
using Polly;
using Prometheus;
using Serilog;
...
[DependsOn(
    ...
    typeof(BookStoreSharedLocalizationModule)
)]
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                options.FileSets.ReplaceEmbeddedByPhysical<ProductServiceWebModule>(Path.Combine(
                    ...
                    $"..{Path.DirectorySeparatorChar}..{Path.DirectorySeparatorChar}..{Path.DirectorySeparatorChar}..{Path.DirectorySeparatorChar}services{Path.DirectorySeparatorChar}product{Path.DirectorySeparatorChar}src{Path.DirectorySeparatorChar}Acme.BookStore.ProductService.Web"));
            });
        }
