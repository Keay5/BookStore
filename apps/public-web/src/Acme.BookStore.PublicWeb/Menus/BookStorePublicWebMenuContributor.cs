...
namespace Acme.BookStore.PublicWeb.Menus;

public class BookStorePublicWebMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public BookStorePublicWebMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                BookStorePublicWebMenus.HomePage,
                l["Menu:Home"],
                "~/",
                icon: "fa fa-home",
                order: 0
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                BookStorePublicWebMenus.ProductPage,
                "Products",
                "/Products",
